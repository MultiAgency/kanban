...
| ------------------------------------------------------------------------------------------------------------- | ------------------------------------- | ---------------------------------------------------------------------------------------------------------------- |
| `gpt-oss-120b` produces malformed repair issues (F26 placeholder leak in the scanner)                         | Scanner files cruft repair issues     | `[FILL:]` markers in repair-scanner prompt + `no-cruft.yml` CI gate (already in place from this session)         |
